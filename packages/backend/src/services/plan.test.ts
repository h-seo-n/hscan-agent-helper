...
import { fallbackPlan, parsePlan } from './plan';
...
describe('fallbackPlan', () => {
  it('returns an explain-only plan without heuristic scenario routing', () => {
    ...
    expect(result.warnings).toEqual(['fallback after two failures']);
  });
});
